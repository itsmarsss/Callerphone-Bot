...
public class TicTacToe implements IMiniGame {
    ...
    public MessageCreateData getMessageForFrom() {
        ...
        if (win != -1) {
            if (win == 0) {
                return getBoardWithMessage("@" + Callerphone.sdMgr.getUserById(fromUserID).getName() + " has won this game!");
            } else if (win == 1) {
                return getBoardWithMessage("@" + Callerphone.sdMgr.getUserById(toUserID).getName() + " has won this game!");
            }
        } else {
            message.setContent("@" + Callerphone.sdMgr.getUserById(toUserID).getName() + " has challenged you to a game of TicTacToe");
        }
    ...
    public MessageCreateData getMessageForTo() {
        ...
        if (win != -1) {
            ...
            message.setContent("@" + Callerphone.sdMgr.getUserById(fromUserID).getName() + " has challenged you to a game of TicTacToe");
        }
