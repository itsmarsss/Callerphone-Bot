...
public enum MIBResponse {
    ...
    MESSAGE_FLAGGED(ToolSet.CP_ERR + "Your message has been flagged. Please remove any links, pings, or profanity."),
    INVALID_SIGNED(ToolSet.CP_EMJ + "Page signed must be `true` or `false`.");
